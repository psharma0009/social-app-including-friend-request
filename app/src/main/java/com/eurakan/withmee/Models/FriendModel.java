...
public class FriendModel {
    ...
    public FriendModel(int id, String name, String fullAddress, String work, String profileImageUrl) {
        this.id = id;
        this.fullname = name;
    ...
    public FriendModel(int id, String mobile, String email, String username, String aadhar, String gender, String address, String work, String status, String city, String studyIn, String dateOfBirth) {
        this.id = id;
        this.mobile = mobile;
        this.email = email;
